                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <_Builtin.Block
                                className="display-inlineflex custom-flex"
                                tag="div"
                              >
                                <_Builtin.Block
                                ...
                                >
                                  <_Builtin.Link
                                    className="button is-icon is-tiny is-all"
                                    button={false}
                                    wized="all_courts_column_button"
                                    block="inline"
                                    options={{
                                      href: "#",
                                    }}
                                  ...
                                  <_Builtin.Link
                                    className="button is-icon is-tiny"
                                    button={false}
                                    wized="court_button"
                                    block="inline"
                                    options={{
                            ...
                            <_Builtin.Block
                              ...
                              data-w-id="3bf6ef48-906c-6954-3b84-47cb5cf21b1d"
                              tag="div"
                              wized="update_booking_trigger"
                              id="delete_trigger"
                            />
