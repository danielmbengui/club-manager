...
export function DialogResetBooking({
  ...
  return (
    <_Component
      className="booking_delete_modal_component devlink reset"
      tag="div"
      {...styleDialogResetBooking}
    >
      <_Builtin.Block className="booking_delete_content-wrapper" tag="div">
        ...
        >
          ...
          >
            ...
            <_Builtin.Block className="modal_header_title" tag="div">
              {"Attention les données seront réinitialisées !"}
            </_Builtin.Block>
            {isLoading ? (
              <_Builtin.Block
        ...
        <_Builtin.Block
          className="booking_delete_close-button devlink"
          tag="div"
          {...close}
        >
          <_Builtin.HtmlEmbed
      ...
      <_Builtin.Block
        className="booking_delete_background-overlay devlink reset-booking"
        tag="div"
      />
    </_Component>
  );
