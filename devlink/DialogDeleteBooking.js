    ...
    <_Component className="booking_delete_modal_component devlink" tag="div">
      <_Builtin.Block className="booking_delete_content-wrapper" tag="div">
        ...
        >
          ...
          >
            ...
            <_Builtin.Block className="modal_header_title" tag="div">
              {
                "Attention une fois supprimé la réservation ne peut plus être récupéré !"
              }
            </_Builtin.Block>
            <_Builtin.Block
          ...
          <_Builtin.Block className="button-group is-center" tag="div">
            ...
            <_Builtin.Link
              ...
              data-w-id="4ba91be8-e260-64dc-e8f8-0c1269c11cc0"
              button={true}
              block=""
              options={{
                href: "#",
        ...
        <_Builtin.Link
          ...
          data-w-id="4ba91be8-e260-64dc-e8f8-0c1269c11cc2"
          button={false}
          block="inline"
          options={{
            href: "#",
      ...
      <_Builtin.Block
        className="booking_delete_background-overlay"
        data-w-id="4ba91be8-e260-64dc-e8f8-0c1269c11cc5"
        tag="div"
      />
    </_Component>
  );
