...
export function Sidebar({ as: _Component = _Builtin.NavbarWrapper }) {
  ...
  return (
    <_Component
      ...
      data-w-id="3abe4b47-4c2f-f07c-4385-5f4f89ad18dc"
      tag="div"
    ...
    >
      <_Builtin.Block className="sidebar4_container" tag="div">
        ...
        >
          <_Builtin.Block className="sidebar4_menu-wrapper" tag="div">
            ...
            <_Builtin.Block className="sidebar4_menu-bottom" tag="div">
              <_Builtin.Link
                className="sidebar4_link support"
                button={false}
                wized="logout_btn"
                block="inline"
                options={{
      ...
      <_Builtin.Block className="sidebar4_close-tablet" tag="div">
        <_Builtin.NavbarButton className="sidebar4_menu-button" tag="div">
          <_Builtin.HtmlEmbed
      ...
      <_Builtin.Block className="sidebar4_background-layer" tag="div" />
    </_Component>
  );
}
